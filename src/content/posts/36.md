...
category: "Go/문서 읽기"
description: "? context 패키지 Go의 context 패키지는 API의 경계를 넘어, 프로세스 간의 종료 시점, 취소 신호 그리고 요청 범위 값을 전달하는 Context 타입을 정의합니다. 쉽게 말해, Context 타입을 사용하여 작업 흐름을 제어할 수 있습니다. type Context in"
tistoryId: 36
---
## context 패키지
