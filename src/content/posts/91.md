...
description: "1. 문제 초능력(?)을 사용해서 10번 연속으로 코인 뒤집기의 결과를 맞춰라. // SPDX-License-Identifier: MIT pragma solidity ^0.8.0; contract CoinFlip { uint256 public consecutiveWins; uint256"
tistoryId: 91
---
## 1\. 문제
