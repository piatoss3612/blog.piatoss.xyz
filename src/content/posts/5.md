...
![web에서 proxy-server로 요청을 보내기 위해 사용한 기반 url](/posts/5/img/img.png)

그러나 아래와 같이 해당 url로는 요청을 보낼 수 없다는 오류가 발생한 것을 확인했다.

![name not resolved 에러](/posts/5/img/img_1.png)

그래서 web 컨테이너의 터미널에서 proxy-server로 ping을 찍어 봤다.

![\`](/posts/5/img/img_2.png)
...
![출처:&nbsp;https://stackoverflow.com/questions/69115729/neterr-name-not-resolved-docker](/posts/5/img/img_4.png)
