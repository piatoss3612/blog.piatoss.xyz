...
category: "Go/문서 읽기"
description: "Go 1.22에 추가된 반복문 변수 할당과 정수 범위 순회를 중심으로 Vet, 런타임, 컴파일러, 표준 라이브러리의 주요 변화를 다룬다."
tistoryId: 128
---
...
![루프마다 변수를 새로 만든다고 적은 릴리스 노트](/posts/128/img/img.webp)
...
![8바이트 정렬 변화까지 함께 적힌 런타임 항목](/posts/128/img/img_1.webp)

### Compiler

PGO(Profile-guided Optimization) 빌드를 통한 탈가상화와 성능 개선.

![탈가상화와 인라이닝을 다룬 컴파일러 항목](/posts/128/img/img_2.webp)
...
- [math/rand/v2: revised API for math/rand · Issue #61716 · golang/go](https://github.com/golang/go/issues/61716)
...
![POST /items에 201 Created가 돌아온 응답](/posts/128/img/blob.webp)

![GET /items가 돌려준 항목 목록](/posts/128/img/blob_1.webp)

핸들러를 GET 메서드로 등록하는 경우에는 HEAD 메서드도 자동으로 등록됩니다.

![따로 등록하지 않은 HEAD에도 돌아온 200 OK](/posts/128/img/blob_2.webp)
...
![/items/1이 돌려준 id 1번 항목](/posts/128/img/blob_3.webp)
...
![이름 없이 부르면 돌아오는 Hello, !](/posts/128/img/blob_5.webp)

![이름 자리에 들어간 piatoss](/posts/128/img/blob_6.webp)

![슬래시까지 통째로 담기는 piatoss/3612](/posts/128/img/blob_7.webp)
...
![뒤에 무엇이 붙어도 매칭되는 /bye/](/posts/128/img/img_3.webp)
...
![{$}를 붙여 정확히 /bye/에만 걸린 응답](/posts/128/img/img_4.webp)
