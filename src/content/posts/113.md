...
description: "delegatecall이 호출자의 스토리지 문맥에서 실행되는 특성을 이용해 라이브러리 주소를 바꾸고, 공격 컨트랙트로 소유권을 탈취하는 과정을 설명한다."
tistoryId: 113
series:
  name: "Ethernaut"
  order: 16
...
- [The Ethernaut](https://ethernaut.openzeppelin.com/level/16)
...
- [\[Ethernaut\] 6. Delegation](/posts/99/)

 우선 인스턴스를 생성할 때 초기화되는 값들은 다음과 같습니다.

![](/posts/113/img/img-3.webp)
...
![](/posts/113/img/img-0.webp)

 timeZone1Library 값이 Attack 컨트랙트의 주소로 변경되었고 owner 값이 제 지갑 주소로 변경된 것을 확인할 수 있습니다.

![](/posts/113/img/img-2.webp)

![](/posts/113/img/img-1.webp)

 인스턴스를 제출하고 마무리합니다.

![](/posts/113/img/6png.webp)
