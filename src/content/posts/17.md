...
description: "유한체 위 타원곡선의 스칼라 곱셈과 군의 성질을 설명하고, 비트코인 서명에 쓰이는 secp256k1 연산을 Go 타입과 메서드로 구현한다."
tistoryId: 17
series:
...
- [piatoss3612/bitcoin-from-scratch](https://github.com/piatoss3612/bitcoin-from-scratch/tree/chapter03)
...
![실수체에서 정의된 타원곡선과 유한체에서 정의된 타원곡선](/posts/17/img/img_1.webp)

![실수체에서 정의된 타원곡선과 유한체에서 정의된 타원곡선](/posts/17/img/img_2.webp)
...
- [Chapter 3. 타원곡선 암호](https://medium.com/programming-bitcoin/chapter-3-%ED%83%80%EC%9B%90%EA%B3%A1%EC%84%A0-%EC%95%94%ED%98%B8-30793370ccc5)
