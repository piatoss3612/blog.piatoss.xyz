...
description: "원격 서비스 장애의 전파를 막는 서킷 브레이커의 닫힘·열림·반 열림 상태 전환을 설명하고 직접 만든 Go 구현과 테스트 과정을 다룬다."
tistoryId: 38
---
## 서킷 브레이커(Circuit Breaker)란?

![](/posts/38/img/img-1.webp)
...
- [piatoss3612/practical-go](https://github.com/piatoss3612/practical-go/tree/05-circuit-breaker)
...
- [회로 차단기 패턴 - Azure Architecture Center](https://learn.microsoft.com/ko-kr/azure/architecture/patterns/circuit-breaker)
- [mercari/go-circuitbreaker](https://github.com/mercari/go-circuitbreaker)
- [sony/gobreaker](https://github.com/sony/gobreaker/tree/master)
