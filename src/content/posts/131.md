...
description: "초기화 코드와 런타임 코드의 구조를 구분하고, 호출 시 42를 반환하는 초소형 컨트랙트를 EVM 바이트코드로 직접 작성해 배포한다."
tistoryId: 131
series:
  name: "Ethernaut"
  order: 18
...
- [The Ethernaut](https://ethernaut.openzeppelin.com/level/18)
...
![](/posts/131/img/img.webp)

![](/posts/131/img/img_1.webp)
...
- [Ethernaut Hacks Level 18: Magic Number](https://dev.to/nvn/ethernaut-hacks-level-18-magic-number-27ep)
- [Deploy contract with Bytecode from smart contract](https://ethereum.stackexchange.com/questions/127940/deploy-contract-with-bytecode-from-smart-contract)
- [velog](https://velog.io/@wooz3k/ethernaut-MagicNumber)
