...
description: "Foundry 테스트로 SimpleAccount의 작업 실행, 서명 검증, 가스비 예치와 인출, UUPS 업그레이드 및 EntryPoint 처리 흐름을 확인한다."
tistoryId: 161
series:
  name: "ERC-4337: 계정 추상화"
  order: 2
---
## 테스트에 참고한 계정 추상화 구현 컨트랙트

- [account-abstraction/contracts at develop · eth-infinitism/account-abstraction](https://github.com/eth-infinitism/account-abstraction/tree/develop/contracts)
...
- [aa-demo-from-scratch/contracts at main · piatoss3612/aa-demo-from-scratch](https://github.com/piatoss3612/aa-demo-from-scratch/tree/main/contracts)
...
- [account-abstraction/contracts at develop · eth-infinitism/account-abstraction](https://github.com/eth-infinitism/account-abstraction/tree/develop/contracts)
- [Upgradable Contracts instantiating an `immutable` value](https://forum.openzeppelin.com/t/upgradable-contracts-instantiating-an-immutable-value/28763/2)
