...
description: "Foundry 프로젝트의 생성·빌드·테스트 명령과 디렉터리 구조를 익히고, Git 서브모듈 기반 의존성 설치와 경로 재매핑 방법을 설명한다."
tistoryId: 63
---
## Foundry 프로젝트 관련 명령어
...
- [Foundry Book](https://book.getfoundry.sh/projects/creating-a-new-project)
