...
category: "Solidity"
description: "0. 이전 게시글 1. .env 파일 업데이트 PRIVATE_KEY=<YOUR_PRIVATE_KEY> RPC_ENDPOINT=http://localhost:8545 RPC_WS_ENDPOINT=ws://localhost:8545 이벤트 구독을 위해서는 웹소켓 주소가 필요 2. 코드 작성"
tistoryId: 73
---
## 0\. 이전 게시글
