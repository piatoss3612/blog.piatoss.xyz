...
category: "Go/코딩 하기"
description: "? 우아하지 않은 종료 다음과 같이 모든 요청에 \"hello world\"로 응답하는 간단한 http 서버가 있습니다. 코드의 실행 순서는 다음과 같습니다. DB 연결 http 서버 시작 http 서버 종료 DB 연결 종료 package main import ( \"context\" \"dat"
tistoryId: 60
---
## **? 우아하지 않은 종료**
