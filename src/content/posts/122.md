...
- [The Ethernaut](https://ethernaut.openzeppelin.com/level/23)
...
|   | player<br>token1 | player<br>token2 | instance<br>token1 | instance<br>token2 |
| --- | --- | --- | --- | --- |
| 시작 | 10 | 10 | 100 | 100 |
| token1 10개를 token2로 교환 | 0 | 20 | 110 | 90 |
| token2 20개를 token1로 교환 | 24 | 0 | 86 | 110 |
| token1 24개를 token2로 교환 | 0 | 30 | 110 | 80 |
| token2 30개를 token1로 교환 | 41 | 0 | 69 | 110 |
| token1 41개를 token2로 교환 | 0 | 65 | 110 | 45 |
| token2 45개를 token1로 교환 | 110 | 20 | 0 | 90 |
...
|   | drain<br>token2 | drain<br>token3 | instance<br>token2 | instance<br>token3 |
| --- | --- | --- | --- | --- |
| 시작 | 0 | 2 | 90 | 0 |
| 2^256 - 1만큼의 token3 사용을 허용 | 0 | 2 | 90 | 0 |
| token3 1개를 전송 | 24 | 1 | 90 | 1 |
| token3 1개를 token2로 교환 | 90 | 0 | 0 | 2 |
...
|   | drain2<br>token1 | drain2<br>token2 | drain2<br>token3 | instance<br>token1 | instance<br>token2 | instance<br>token3 |
| --- | --- | --- | --- | --- | --- | --- |
| 시작 | 0 | 0 | 4 | 100 | 100 | 0 |
| 2^256 - 1만큼의 token3 사용을 허용 | 0 | 0 | 4 | 100 | 100 | 0 |
| token3 1개를 전송 | 0 | 0 | 3 | 100 | 100 | 1 |
| token3 1개를 token1로 교환 | 100 | 0 | 2 | 0 | 100 | 2 |
| token3 2개를 token2로 교환 | 100 | 100 | 0 | 0 | 0 | 4 |
