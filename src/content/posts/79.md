...
category: "Go/코딩 하기"
description: "? 이전 게시글 2023.12.21 - [Go/코딩 하기] - [Go] Polygon ID와 Websocket을 사용한 신원 인증 - 3. 로그인 ? KYCAge Credential 발급 받기 ? 신원 인증 절차 클라이언트 => 서버 websocket 연결 요청 websocket 이 연"
tistoryId: 79
---
## **? 이전 게시글**

[2023.12.21 - \[Go/코딩 하기\] - \[Go\] Polygon ID와 Websocket을 사용한 신원 인증 - 3. 로그인](https://piatoss3612.tistory.com/78)
