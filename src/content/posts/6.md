...
category: "개발 부스러기"
description: "2023.04.02 - [조미료 보관함] - [Trouble Shooting] net::ERR_NAME_NOT_RESOLVED 바로 이전 글에서 브라우저가 docker compose의 default 네트워크 외부에서 네트워크 내부에 있는 서비스에 접근하려고 시도함으로 인해 발생한 오류와"
tistoryId: 6
---
[2023.04.02 - \[조미료 보관함\] - \[Trouble Shooting\] net::ERR\_NAME\_NOT\_RESOLVED](https://piatoss3612.tistory.com/5)
...
![브라우저에서 api 요청을 위해 사용하는 기반 url](/posts/6/img/img.png)
...
![](/posts/6/img/%EC%A0%9C%EB%AA%A9%20%EC%97%86%EB%8A%94%20%EB%8B%A4%EC%9D%B4%EC%96%B4%EA%B7%B8%EB%9E%A8.jpg)

## **\# Test**

![](/posts/6/img/img_1.png)

![](/posts/6/img/img_2.png)

![](/posts/6/img/img_3.png)
