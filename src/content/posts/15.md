...
description: "비트코인 암호학의 기초인 유한체의 정의와 나머지 연산, 덧셈·뺄셈·곱셈·거듭제곱을 배우고 Python 예제를 Go 구조체와 메서드로 옮긴다."
tistoryId: 15
series:
...
- [piatoss3612/bitcoin-from-scratch](https://github.com/piatoss3612/bitcoin-from-scratch/tree/chapter01)
