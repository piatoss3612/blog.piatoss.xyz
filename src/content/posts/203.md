...
[ERC-4337: 계정 추상화 - 간단 정리](/posts/167/)
...
![EIP-1559 필드에 authorization_list가 더해진 0x04](/posts/203/img/2025-02-13-10.44.14.webp)
...
![승인 튜플의 chain_id·address·nonce가 뜻하는 것](/posts/203/img/2025-02-13-11.10.38.webp)
...
![비밀키로 sigHash에 서명해 얻는 r, s, v](/posts/203/img/2025-10-06-3.20.28.webp)
...
![서명부터 EVM 실행까지, 클라이언트의 처리 순서](/posts/203/img/2025-02-13-11.36.07.webp)
...
![authority 복원부터 위임 지정자 부착까지](/posts/203/img/2025-02-13-11.58.33.webp)
...
![위임 지정자가 붙어 있는 EOA를 호출한다](/posts/203/img/2025-10-06-5.00.43.webp)

 트랜잭션 검증 단계에서 이더리움 클라이언트는 먼저 EOA의 위임 지정자를 파싱 하여 address를 가져옵니다.

![0xef0100 뒤에서 떼어낸 address](/posts/203/img/2025-10-06-5.03.25.webp)

그리고 드럼통(state db)에서 주소가 가리키고 있는 code를 찾아와 EOA에 임시로 부착합니다.

![state db에서 그 주소의 code를 꺼내 온다](/posts/203/img/2025-10-06-5.09.37.webp)
...
![실제로 실행되는 것은 EOA에 임시로 붙은 code](/posts/203/img/2025-10-06-5.16.03.webp)
...
| **위임 지정자(Delegation Designation)** | EOA에 실제로 붙는 코드: \`0xef0100&lt;address&gt;\`<br>실제 코드를 가진 컨트랙트 주소를 가리키는 포인터 |   |
