...
description: "문제 취약점 이전 문제의 취약점은 UniswapV1의 즉각적인 가격 반영으로 인한 오라클 가격 조작이었습니다. 그래서 이번에는 UniswapV2를 사용한 새로운 버전을 사용했군요! 그리고 이번에는 ETH를 직접 사용하는 대신 WETH를 사용하였습니다. 또한 이전에는 담보의 양이 빌릴 토"
tistoryId: 146
---
## **문제**
...
 이전 문제의 취약점은 [UniswapV1의 즉각적인 가격 반영으로 인한 오라클 가격 조작](https://piatoss3612.tistory.com/145)이었습니다. 그래서 이번에는 UniswapV2를 사용한 새로운 버전을 사용했군요! 그리고 이번에는 ETH를 직접 사용하는 대신 WETH를 사용하였습니다. 또한 이전에는 담보의 양이 빌릴 토큰의 가격의 두 배였는데, 이번에는 세 배로 늘렸습니다.
