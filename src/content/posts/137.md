...
description: "Truster 문제 취약점 파라미터로 받은 target 주소로 data와 함께 call 함수를 호출합니다. 어떤 주소의 어떤 함수든 호출할 수 있으므로 함수 실행의 결과가 예측이 어렵습니다. 특히 caller가 컨트랙트가 되기 때문에 approve나 transfer 함수를 호출해 컨트랙"
tistoryId: 137
---
## **Truster**
