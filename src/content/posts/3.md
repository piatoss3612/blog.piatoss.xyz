...
category: "Go/문서 읽기"
description: "Package names 패키지를 임포트하면, 패키지 이름은 해당 패키지에 포함된 컨텐츠에 대한 접근자로 사용됩니다. import \"bytes\" func main() { _ = bytes.NewBuffer([]byte{}) } 좋은 패키지 이름은 짧고 간결하며 관련된 컨텐츠들을 연상시킬"
tistoryId: 3
---
# Package names
