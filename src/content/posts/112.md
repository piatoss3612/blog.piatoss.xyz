...
description: "ERC20의 approve와 transferFrom을 이용해 transfer에만 적용된 시간 잠금을 우회하고, 표준 기능에 덧붙인 제한 로직의 허점을 설명한다."
tistoryId: 112
series:
  name: "Ethernaut"
  order: 15
...
![](/posts/112/img/img-0.webp)

 컨트랙트가 배포되고 나면, 컨트랙트 주소를 대상으로 현재 가지고 있는 모든 토큰에 대한 임시 권한을 부여합니다.

![](/posts/112/img/img-1.webp)

 트랜잭션이 컨펌되고 나면, 배포한 컨트랙트의 withdraw 함수를 호출하여 자신의 계정에 있는 모든 토큰을 컨트랙트로 옮깁니다.

![](/posts/112/img/img.webp)

 트랜잭션이 컨펌되고 자신의 계정에 들어있는 잔액을 확인하면 0이 된 것을 확인할 수 있습니다.

![](/posts/112/img/img-2.webp)

 인스턴스를 제출하고 마무리합니다.

![](/posts/112/img/img-3.webp)

---

## 3\. 결론

- [ERC 20 - OpenZeppelin Docs](https://docs.openzeppelin.com/contracts/5.x/api/token/erc20#ERC20)
