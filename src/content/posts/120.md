...
description: "유동성 풀의 토큰 보유량 추적과 상수곱 가격 결정 원리를 설명한다. 유동성 공급의 필요성과 위험을 바탕으로 페어 컨트랙트 구현을 해설한다."
tistoryId: 120
series:
  name: "Uniswap V2"
  order: 3
...
![50 × 100 = 5000으로 잡힌 풀의 k](/posts/120/img/img-1.webp)

2\. Alice가 10개의 시바이누 토큰을 페페 코인으로 스왑 하려고 합니다.

![](/posts/120/img/img_1.webp)
...
![페페를 100 - x로 줄여 k를 지키는 계산](/posts/120/img/img_2.webp)

4\. Alice가 다시 한번 10개의 시바이누 토큰을 페페 코인으로 교환하려고 합니다.

![60 × 84가 된 풀에 다시 온 같은 요청](/posts/120/img/img_3.webp)

5\. 그런데 이번에는 페페 코인을 12개를 받았습니다. 지난번에 스왑 할 때는 분명 16개였는데 12개로 줄어들어 버리다니... 나머지 4개의 페페 코인은 어디로 가버린 것일까요?

![70 × 72가 되면서 12개로 줄어든 몫](/posts/120/img/img_4.webp)
...
![거래가 보유량을 옮겨 새 가격을 만드는 과정 (Uniswap V2 문서)](/posts/120/img/img.webp)
...
![](/posts/120/img/m_1645876288_4808.webp)
...
![1 SHIB = 2 PEPE일 때 들어간 Charlie의 공급량](/posts/120/img/img_12.webp)

 몇 차례 거래가 발생하고 나서 유동성 풀에서의 토큰 가격이 1 시바이누 토큰당 3.125 페페 코인으로 변동됩니다.

![가격이 3.125로 움직여 4000 × 12500이 된 풀](/posts/120/img/img_13.webp)

 이 경우 Charlie의 지분에 따른 유동성 풀에서의 실제 보유량은 400개의 시바이누 토큰과 1250개의 페페 코인으로 변동됩니다.

![500·1000으로 넣고 400·1250이 된 몫](/posts/120/img/img_14.webp)
...
![들고 있었다면 2562.5, 공급했다면 2500](/posts/120/img/img_15.webp)
...
![가격이 움직인 만큼 벌어지는 유동성 가치의 손실 (Uniswap V2 문서)](/posts/120/img/img_16.webp)
...
[\[Solidity\] 재진입 공격 예방 기법](/posts/33/)
...
![블록마다 가격 × 경과 시간을 더해 쌓는 누적값 (Uniswap V2 문서)](/posts/120/img/img_17.webp)
...
![두 시점의 누적 가격 차를 시간으로 나눈 TWAP (Uniswap V2 문서)](/posts/120/img/img_18.webp)
...
![](/posts/120/img/3f2fd88a45aef73bb0e951b81065834e.webp)

---

## 전체 코드

- [piatoss3612/dig-defi](https://github.com/piatoss3612/dig-defi)

---

## 참고

- [Overview | Uniswap](https://docs.uniswap.org/contracts/v2/overview)
...
- [Uniswap/v2-core](https://github.com/Uniswap/v2-core/tree/master)
