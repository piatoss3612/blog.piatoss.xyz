...
category: "Solidity"
description: "0. 이전 게시글 1. .env 파일 업데이트 PRIVATE_KEY=<YOUR_PRIVATE_KEY> RPC_ENDPOINT=<YOUR_RPC_ENDPOINT> RPC_WS_ENDPOINT=ws://localhost:8545 ETHERSCAN_API_KEY=<YOUR_ETHERSCAN_"
tistoryId: 75
---
## **0\. 이전 게시글**
