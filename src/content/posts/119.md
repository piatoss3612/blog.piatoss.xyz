...
description: "팩토리 컨트랙트의 상태와 접근 제어, 토큰 페어 생성 절차를 코드와 테스트로 검증한다. CREATE와 CREATE2의 주소 결정 방식도 비교한다."
tistoryId: 119
series:
  name: "Uniswap V2"
  order: 2
...
![factory 패턴](/posts/119/img/img.webp)
...
- [Pitfalls of Using CREATE, CREATE2 and EXTCODESIZE Opcodes](https://mixbytes.io/blog/pitfalls-of-using-cteate-cteate2-and-extcodesize-opcodes)
...
![](/posts/119/img/53e5a2c6420cab0014.webp)
...
- [Foundry Book](https://book.getfoundry.sh/cheatcodes/expect-emit)
- [Foundry Book](https://book.getfoundry.sh/tutorials/create2-tutorial)
- [EIP-1014: Skinny CREATE2](https://eips.ethereum.org/EIPS/eip-1014)
- [Solidity by Example](https://solidity-by-example.org/app/create2/)
