...
category: "개발 부스러기"
description: "노트북 포맷한 김에 작성하는 글. Terraform 설치 $ sudo apt-get update && sudo apt-get install -y gnupg software-properties-common $ wget -O- https://apt.releases.hashicorp.com/"
tistoryId: 84
---
> 노트북 포맷한 김에 작성하는 글.
