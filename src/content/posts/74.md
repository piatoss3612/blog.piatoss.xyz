---
title: "[Solidity+Go] geth로 스마트 컨트랙트 배포하기 - 6. 메타데이터를 사용한 standard json input 생성"
date: 2023-12-15T13:00:52+09:00
category: "Solidity"
description: "솔리디티 컨트랙트 메타데이터에서 컴파일 설정과 소스 정보를 추출해 검증용 표준 JSON 입력 파일을 생성하고 결과를 테스트한다."
tistoryId: 74
series:
