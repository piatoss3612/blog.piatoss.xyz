...
description: "Ethernaut Bet House의 토큰 발행 제한과 출금 순서 문제를 분석하고, 컨트랙트 호출과 재진입을 이용해 필요한 토큰을 확보하는 공격 과정을 구현한다."
tistoryId: 201
series:
  name: "Ethernaut"
  order: 34
...
- [The Ethernaut](https://ethernaut.openzeppelin.com/level/34)
