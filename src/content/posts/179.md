...
category: "Go/문제 풀이"
description: "문제 https://www.acmicpc.net/problem/18428 풀이 N의 최댓값이 6으로, N^6도 5만이 채 되지 않습니다. 따라서 완전 탐색을 통해 장애물을 놓을 위치를 선택합니다. 3개의 장애물을 모두 설치하고 나면, 모든 선생님의 위치에서 상하좌우 모든 방향에 대해 장"
tistoryId: 179
---
## **문제**
