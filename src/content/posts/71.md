...
category: "Solidity"
description: "1. 로컬 테스트넷 실행 $ anvil 2. 최상위 경로에 .env 파일 생성 PRIVATE_KEY=<anvil 실행 시 제공되는 프라이빗 키 중 하나> RPC_ENDPOINT=http://localhost:8545 이 때 PRIVATE\\_KEY가 0x로 시작하면 파싱에서가 발생하므로 "
tistoryId: 71
---
## **1\. 로컬 테스트넷 실행**
