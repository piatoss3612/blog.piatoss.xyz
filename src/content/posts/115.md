...
- [The Ethernaut](https://ethernaut.openzeppelin.com/level/19)
...
- [Layout of State Variables in Storage — Solidity 0.8.25 documentation](https://docs.soliditylang.org/en/latest/internals/layout_in_storage.html)
