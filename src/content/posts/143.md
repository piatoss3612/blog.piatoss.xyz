...
description: "문제 취약점 렌딩 풀이 가지고 있는 거버넌스 토큰을 탈취해야 합니다. 우선 렌딩 풀부터 살펴봅시다. 이번 렌딩 풀의 특이사항은 거버넌스 컨트랙트와 상호작용한다는 것입니다. 거버넌스 컨트랙트에서 drainAllFunds를 호출하면 가지고 있는 모든 거버넌스 토큰을 전송하는데, 이를 활용할"
tistoryId: 143
---
## **문제**
