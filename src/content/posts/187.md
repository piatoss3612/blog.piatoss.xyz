...
description: "인터페이스를 이해하고 활용하기 위한 글. 암호학에 대해서는 간략하게 다룹니다. EIP-7212: secp256r1 곡선을 지원하기 위한 프리컴파일 개요 메시지 해시, 서명의 r과 s 그리고 공개키의 x와 y를 매개변수로 받아 'secp256r1' 타원 곡선에서의 서명을 검증하는 프리컴파"
tistoryId: 187
---
