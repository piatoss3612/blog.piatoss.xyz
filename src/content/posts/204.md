...
description: "Magic Animal Carousel의 비트 마스킹과 스토리지 압축 구조를 해석하고, 동물 등록과 이름 변경 로직의 허점을 이용해 규칙을 깨는 공격을 구현한다."
tistoryId: 204
series:
  name: "Ethernaut"
  order: 33
...
- [The Ethernaut](https://ethernaut.openzeppelin.com/level/35)
