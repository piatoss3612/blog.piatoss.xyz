...
description: "ERC-2612 permit이 서명으로 토큰 사용 권한을 갱신하는 구조를 설명한다. 도메인 구분자와 논스, 만료 및 서명 재사용 방지 로직을 테스트한다."
tistoryId: 118
series:
  name: "Uniswap V2"
  order: 1
...
![](/posts/118/img/20240130_182956.webp)
...
- [Foundry Book](https://book.getfoundry.sh/tutorials/testing-eip712)
- [ERC-191: Signed Data Standard](https://eips.ethereum.org/EIPS/eip-191)
