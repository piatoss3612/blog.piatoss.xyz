...
description: "1. 문제 문지기(gatekeeper)를 지나서 입장자(entrant)로 등록하라. // SPDX-License-Identifier: MIT pragma solidity ^0.8.0; contract GatekeeperTwo { address public entrant; modifier"
tistoryId: 111
---
## 1\. 문제
