...
- [6 Ways To Boost the Performance of Your Go Applications](https://betterprogramming.pub/6-ways-to-boost-the-performance-of-your-go-applications-5382bb7532d7)
- [What are the possible consequences of using unsafe conversion from \[\]byte to string in go?](https://stackoverflow.com/questions/33952378/what-are-the-possible-consequences-of-using-unsafe-conversion-from-byte-to-str/33953027#33953027)
- [How to use unsafe get a byte slice from a string without memory copy](https://stackoverflow.com/questions/59209493/how-to-use-unsafe-get-a-byte-slice-from-a-string-without-memory-copy?noredirect=1&lq=1)
