...
![gRPC 클라이언트에서 다이렉트로 요청한 경우의 메타데이터](/posts/4/img/client-direct.png)

![프록시 서버를 통해 요청한 경우의 메타데이터](/posts/4/img/proxy.png)
...
![gRPC 클라이언트에서 다이렉트로 요청한 경우의 메타데이터 출력](/posts/4/img/img.png)

![프록시 서버를 통해 요청한 경우의 메타데이터 출력](/posts/4/img/img_1.png)
...
![gRPC 클라이언트에서 다이렉트로 요청한 경우의 메타데이터 출력](/posts/4/img/img_2.png)
